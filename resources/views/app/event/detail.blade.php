    ...
    <section class="eventmap-map">
        <div class="container">
            <div class="info-container">
                ...
                <div class="eventmap-article__header eventmap-article-header row wrap">
                    <div class="eventmap-article__column">
                        <div class="eventmap-info"><img class="eventmap-info__icon" src="{{ asset('images/pointer.0b286a1b.svg') }}"
                                                        alt="pointer" aria-hidden="true">
            ...
            <div class="align-center column row"><h2 class="pricing-contacts__title">Контакты</h2>
                ...
                <ul class="center pricing-contacts-social row">
                    <li class="pricing-contacts-social__item"><a class="pricing-contacts-social__link" href="#">
                            <img class="pricing-contacts-social__icon" src="{{ asset('images/social-twitter.5757a209.svg') }}" alt="twiiter"></a>
                    </li>
                    <li class="pricing-contacts-social__item"><a class="pricing-contacts-social__link" href="#">
                            <img class="pricing-contacts-social__icon" src="{{ asset('images/scoail-facebook.6c0c36fd.svg') }}"
                                 alt="facebook"></a></li>
                    <li class="pricing-contacts-social__item"><a class="pricing-contacts-social__link" href="#">
                            <img class="pricing-contacts-social__icon" src="{{ asset('images/social-Instagram.0fe232e6.svg') }}"
                                 alt="Instagram"></a></li>
                </ul>
            </div>
        </div>
